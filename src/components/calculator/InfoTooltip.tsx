      ...
      <AnimatePresence>
        {showInfo && (
          <motion.div
            ...
            className="absolute top-0 right-6 md:left-6 bg-white border border-gray-300 rounded shadow-lg p-1 md:p-3 text-xs text-gray-500 w-52 md:w-64 z-50"
          >
            <div className="mb-2">
              <h4 className="font-bold">De Dólar a Peso</h4>
              <ul className="list-disc list-inside">
                <li>Transacción hasta 24 horas.</li>
                <li>Comisión 5.5% + 10 USD de cobro (Paypal con 4,5% de gasto adicional)</li>
              </ul>
            </div>
            <div>
